...
export const FirebaseConfigError = ({ error }) => {
  ...
  const isPermissionError = error?.message?.includes('permissions') || 
                           error?.message?.includes('Firestore Rules') ||
      ...
      <div className="max-w-2xl w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
            {isPermissionError ? 'Firestore Permission Error' : 'Firebase Configuration Error'}
          </h1>
        </div>
          ...
          {isPermissionError ? (
            <>
              <p className="text-gray-700 dark:text-gray-300">
                Firestore permissions saknas. Kontrollera Firestore Rules i Firebase Console.
              </p>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800 dark:text-blue-200">
                  <li>Gå till <strong>Firebase Console</strong> → Välj ditt projekt</li>
                  <li>Klicka på <strong>Firestore Database</strong> → <strong>Rules</strong></li>
                  <li>Kopiera innehållet från <code className="bg-white dark:bg-gray-700 px-1 rounded">firestore.rules</code> i projektet</li>
                  <li>Klistra in reglerna i Firebase Console</li>
                  <li>Klicka på <strong>Publish</strong></li>
                </ol>
              </div>

              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>Viktigt:</strong> Security Rules måste deployas för att appen ska fungera. 
                  Utan korrekta rules kommer Firestore att blockera alla läs- och skrivförsök.
                </p>
              </div>

              <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Efter att du har deployat Security Rules kommer appen automatiskt att fungera.
                  Du behöver inte göra en ny deployment i Vercel.
                </p>
              </div>
            </>
          ) : (
